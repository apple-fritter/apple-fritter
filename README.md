...
#### 💞️ I’m looking to `collaborate on projects` that `facilitate education`, `aide those with impairments`, and `keep minds active` and `communicating`. I'm particularly interested in `exploring` [Rust](https://www.rust-lang.org/) further.
